...
M3_READ_ONLY_STAGING_DISCOVERY = BLOCKED
...
M3_READ_ONLY_STAGING_DISCOVERY_BLOCKERS = groups.getSettings unavailable with configured group token; selected Callback server status=failed and api_version=5.130
M3_WRITE_STAGING = PENDING
M3_REAL_MESSAGE_NEW_FIXTURE = PENDING
M3_REAL_MESSAGES_SEND_FIXTURE = PENDING
M3_STAGING_CONTRACT_GATE = BLOCKED
