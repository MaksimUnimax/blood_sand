...
M3_PLAIN_TEXT_RUNTIME_IMPLEMENTATION = BLOCKED_LOCAL_ACCEPTANCE
M3_PLAIN_TEXT_RUNTIME_LOCAL_TESTS = BLOCKED
M3_PLAIN_TEXT_RUNTIME_LOCAL_ACCEPTANCE = BLOCKED
...
NEXT_M3_GATE = M3_LOCAL_ACCEPTANCE_COMPLETION
```
