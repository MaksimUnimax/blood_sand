...
class VKAPIClient:
 ...
 def messages_send(self,peer_id:int,message:str,random_id:int,keyboard:str|None=None,attachments:list[str]|None=None)->VKAPIResult:
  ...
  if attachments: data['attachment']=','.join(attachments)
