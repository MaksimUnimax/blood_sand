...
Этот root set покрывает четыре стратегических слоя, не дублируя десятки близких seed phrases заранее.
...
Live GetTop для `печать велеса`, Россия, all devices:
...
## 7. Первый следующий measurement

`GetTop("оберег печать велеса")`, Россия (`225`), `DEVICE_ALL`, `numPhrases=100`.

Причина: это прямой product-commercial root, уже присутствующий в live `печать велеса` result, но отдельный GetTop нужен для собственного broad total и специализированного хвоста вокруг именно оберега.
