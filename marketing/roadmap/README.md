...
Следующий пункт — **03: полностью измерить поисковый спрос / Wordstat**.

Пункт 03 пока `[ ]` и не считается начатым. Перед первым measurement по нему нужно создать его детальный файл с конечным списком шагов и уточнённой оценкой ранов.