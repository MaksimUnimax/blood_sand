...
- P6.4 `[ACTIVE]` existing plan, price, entitlement and compatibility policy operations. Local implementation is accepted; final P6.4 completion remains with the remote acceptance gate.
