...
- P7.3 [ACTIVE / LOCAL ACCEPTED / REMOTE ACCEPTANCE PENDING] bootstrap AI resolution, signed wire contract, and simulated-client automatic selection.
...
- P7.3 [ACTIVE / LOCAL ACCEPTED / REMOTE ACCEPTANCE PENDING].
- P7.4 [PLANNED].
- P7.5 [PLANNED].
- P7.6 [PLANNED].
