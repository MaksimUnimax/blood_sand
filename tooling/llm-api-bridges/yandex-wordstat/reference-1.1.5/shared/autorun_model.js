(() => {
  ...
  function pauseDecision(status) {
    ...
    if (status === RUN_STATUSES.STARTING || status === RUN_STATUSES.REQUESTING || status === RUN_STATUSES.DELIVERING) return "deferred";
  ...
  globalThis.WordstatAutorunModel = Object.freeze({
    RUN_STATUSES,
    START_PHASES,
    DELIVERY_PHASES,
    normalizeIdList,
