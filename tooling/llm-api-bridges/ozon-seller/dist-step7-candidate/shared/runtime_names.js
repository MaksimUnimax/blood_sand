(() => {
  ...
  const DEFAULT_AUTO_START_TEXT = [
    ...
    "В одном ответе могут находиться несколько независимых command envelopes; OZON_HELP_V2 и OZON_API_V1 могут находиться в одном ответе, но все они должны быть внутри единственного command block и обрабатываются последовательно в исходном порядке.",
