...
const perfCredsJson=JSON.stringify(perfCreds||{});
assert(perfCreds&&typeof perfCreds==='object'&&perfCredsJson.includes('PERF_CLIENT_ID')&&perfCredsJson.includes('PERF_CLIENT_SECRET'),'Performance credentials were not normalized from current client_id/client_secret shape');
